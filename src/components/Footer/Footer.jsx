    ...
    return <footer className=" bg-[#12141e] pt-12">
        ...
        <div className="container">
          <div className="sm:flex items-center justify-between md:gap-8 ">
            ...
            <div className="w-full sm:w-1/2">
              <p className="text-gray-300 leading-7 mt-4 sm:mt-0 ">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Minus quaerat neque laboriosam culpa deleniti error inventore nobis ratione 
                vel eaque quod, sit autem architecto beatae temporibus enim veritatis commodi aliquam?</p>
              <div className="flex gap-4 flex-wrap items-center md:gap-8 mt-10  ">
          ...
          <div>
            <ul className="flex items-center justify-center gap-[15px] mt-10">
              <li>
        ...
        <div className="bg-[#1b1e29] py-5 mt-14 ">
          <div className="container">
            <div className="flex items-center justify-center sm:justify-between ">
              ...
              <div className="hidden sm:block">
                <div className="flex items-center gap-[10px]">
                  ...
                  <div className="leading-[20px] ">
                    <h2 className="text-gray-200 font-[500] text-[18px] ">Shaheen</h2>
              ...
              <div>
                <p className="text-gray-400 text-[14px]  ">Copyright {year} developed by Shaheen - All right reserved.</p>
              </div>
            </div>
          </div>
        </div>
