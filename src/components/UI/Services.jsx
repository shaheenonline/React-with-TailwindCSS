        ...
        <section id="services">
            <div className="container lg:pt-5">
                <div className="text-center">
                    ...
                    leading-7">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae sint asperiores ad, nesciunt, nemo libero dolor 
                        vero natus, enim itaque repudiandae! Consectetur animi nostrum sequi ullam quasi aspernatur quis sint.
                    </p>
                </div>
                    ...
                    <div className="w-full py-3 px-2 sm-max-w-xl sm:mx-auto sm:px-0">
                        <div className="relative text-gray-700 antialiased text-sm font-semibold  ">
                            ...
                            <div className="mt-6 sm:mt-0 sm:mb-12">
                                        ...
                                        <div className="w-full sm:w-1/2 sm:pr-8">
                                            <div 
                                                ...
                                                cursor-pointer ease-in duration-[150] ">
                                                    ...
                                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores iste repellat 
                                                    aliquid eius, nisi sunt facere ad distinctio pariatur quaerat officiis praesentium omnis. 
                                                    Aperiam laudantium esse placeat praesentium minima dolor.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                absolute left-1/2 -translate-x-1/2 -translate-y-4 sm:translate-y-0 flex 
