...
import all from '../../assets/data/portfolioData';
                            ...
                            key={index}
                                ...
                                <div className="w-full h-full bg-primaryColor bg-opacity-40 absolute top-0 left-0
                                    ...
                                    <div className="w-full h-full flex items-center justify-center">
                                        <button onClick={()=>showModalHandler(portfolio.id)} className="text-white bg-headingColor hover:bg-smallTextColor
                                        py-2 px-4 rounded-[8px]">See Details</button>
                                    </div>
                                </div>
                            </div>
                        ))
