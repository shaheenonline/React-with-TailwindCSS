            ...
            <div className="container">
                ...
                <div className="md:flex justify-between items-center">
                    <div className="w-full md:w-1/2 h-[300px] sm:h-[450px]">
                        <iframe title="google-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14719.230501972948!2d75.89906228542043!3d22.73539061057233!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3962e2b039622859%3A0xdd0df8d9fe32ec13!2sKhajrana%2C%20Indore%2C%20Madhya%20Pradesh!5e0!3m2!1sen!2sin!4v1689770072445!5m2!1sen!2sin" 
                    ...
                    lg:px-8 py-8">
                        <form action="" className="w-full">
                            ...
                            <div className="mb-5">
                                <textarea type="text" rows={3} placeholder="Write your message" className="w-full p-3 focus:outline-none 
                                rounded-[5px]" />
                            </div>
